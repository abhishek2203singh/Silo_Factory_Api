...
const PackagingDptModel = sequelize.define(
    "Packaging_Department",
    {
        ...
        department_id: {
            type: DataTypes.INTEGER,
            allowNull: false,
            comment: "destination department where we sending this entry",
        },
        departmenthead_id: {
            type: DataTypes.INTEGER,
            allowNull: false,
    ...
    {
        tableName: "Packaging_Department",
