...
import { MasterEntryTypeModel } from "./masterEntryType.model.js";
import { UnitModel } from "./unit.model.js";
import { ProductModel } from "./product.model.js";
import Sequelize from "sequelize";
const PasteurizationDptModel = sequelize.define(
    "Pasteurization_Department",
    {
        id: {
    ...
    {
        tableName: "Pasteurization_Department",
        timestamps: false,
    }
);
PasteurizationDptModel.belongsTo(MasterEntryTypeModel, {
    foreignKey: "entry_type_id",
});

PasteurizationDptModel.belongsTo(ProductModel, {
    foreignKey: "product_id",
});

PasteurizationDptModel.belongsTo(UnitModel, {
    foreignKey: "unit_id",
});

export { PasteurizationDptModel };
